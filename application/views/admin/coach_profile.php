            ...
            <div class="box-body"  >
             <?php foreach($coach_profile as $profile){ ?>
                    ...
                    <div class="col-md-9 text-center">
                        <div class="col-md-12">
                                <p style="color: #000000;" class="fa-2x"><?php echo $profile['coach_fname']." ".$profile['coach_lname']. " ".$profile['coach_other_names'];?></p> 
                                <small><cite title="<?php echo $profile['coach_fname'];?>'s residence"><i class="fa fa-map-marker"> </i> <?php echo $profile['coach_residence'];?>  </cite></small>
                            <hr>
                        </div>
                        ...
                        <div class="col-md-6" style="text-align: left">
                            <blockquote >
                                 ...
                                 <p><i class="fa fa-exclamation-circle text-danger fa-1x"></i>Yes  <span><cite title="course';  echo $profile['coach_fname']; echo 'takes/took"><small style="display: inline"> </small></cite></span> </p>';}?>
                            </blockquote>
                            <hr>
                        </div>
                    </div>
                    <div class="col-md-12 text-center">
                        ...
                        <div class="col-md-12" style="text-align: left">
                         <p><i class="fa fa-info-circle  text-info fa-1x"></i> <?php echo $profile['coach_fname']. " ".$profile['coach_lname'] ;?> has been the coach of <?php echo $profile['team_category']." ";?> since <?php echo date_format(date_create($profile['date_appointed']),"j<\s\up>S</\s\up> M, Y");?>. <?php $endDate=$profile['end_of_tenure'];if($endDate==""){echo "<b style='color:darkgreen'> <i class='fa fa-check-circle-o'></i> Tenure Ongoing</b>";}else{ echo date_format(date_create($profile['end_of_tenure']),"j<\s\up>S</\s\up> M, Y");}?></p>
                        </div>
                        </blockquote>
                    </div>
                    <?php }?>
