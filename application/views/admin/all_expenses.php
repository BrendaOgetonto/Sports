  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
        <div class="row " style="margin-bottom: -15px;">
            <div class="col-lg-12 " >
                <h4 class="pull-left"><b>Dashboard</b> <span class="fa fa-angle-double-right"></span> All Expenditures</h4>
                    ...
                    <tbody >
                       <?php foreach($expenses as $exps){ 
                        ...
                        <tr>
                            ...
                            <td class="text-left"><?php  echo $exps['team_category']." (<span style='color:#0E6655'>".$exps['expense_category']."</span>)";?></td>
                            ...
                            <td class="text-center">
                                <form style="display:inline;" name=<?php echo '"formMore_'. $exps['expense_auto_id'].'"';  ?> method="post" action="<?php echo base_url('dos/expenditureinfo');?>">
...
$(document).ready(function () {
    ...
    //define datatable
     var table=$('#expenselist').dataTable({responsive:true,"iDisplayLength": 7,"lengthMenu": [[7, 25, 50, 100, 200, -1], [7, 25, 50, 100, 200, "All"]],
         "aoColumnDefs": [{"bSortable":false, "aTargets": [5]}],'aaSortable':[]
   });
