  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
        <div class="row" style="margin-bottom: -15px;">
            <div class="col-lg-12 ">
                <h4><b>Dashboard</b> <span class="fa fa-angle-double-right"></span>Edit Travel Document for <b class="text-success"><?php echo $this->session->userdata('pst_player_name');?></b></h4>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="messagebox alert alert-success" style="display: block">
                 ...
                 <?php foreach($passport_details as $pspt){
                  ...
                  echo form_open_multipart('coach/updateplayerpspt',array('id'=>'updateplayerpspt','method'=>'post'));
