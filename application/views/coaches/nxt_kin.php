                 ...
                 $photo=$nxt['player_profile_photo']; if($photo==""){$ppic="defaultimage.png";}else{$ppic=$nxt['player_profile_photo'];}?>
                    <div class="col-md-9 text-left">
                        <div class="col-md-12">
                            ...
                            <small><cite title="Player"><b><img src="<?php echo base_url();echo 'uploads/profile_photos/players/'.$ppic?>" width="30" height="30" class="img-circle" alt="User Image"> </b> Player: <?php echo $nxt['player_fname']." ".$nxt['player_lname']. " ".$nxt['player_other_names'];?>  </cite></small>
                            <br><br>
                        </div>
