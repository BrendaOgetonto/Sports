...
<head>
    ...
    <title>SUSMS - Edit Coach Remarks </title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="modal-body">
            <form role="form" method="post" action="<?php echo base_url(); ?>coach/update_remark" id="edit_coach_remarks" >
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group col-md-12 col-lg-12" hidden="true">
                                ...
                                <input type="text" name="recordId" placeholder="Record Id" class=" form-control" id="recordId" required="required" readonly="true" value="<?php echo $record['injury_auto_id']; ?>">
                            </div>
                            ...
                            <div class="form-group col-md-12 col-lg-12">
                                ...
                                <textarea required="required" class="form-control" name="coachRemarks" placeholder="e.g. Give training break"><?php echo $record['coach_remarks'];} ?></textarea>
                            </div>
