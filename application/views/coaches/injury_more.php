          ...
          <div class="box" >
            <div class="box-body"  >
                ...
                <div class="form-group col-md-12 col-lg-12">
                    <strong class="fa-2x"><img src="<?php echo base_url();?>assets/img/person.png" width="40" height="40" class="img-circle" alt="User Image">  <?php echo $record['player_fname']. " ".$record['player_lname']; ?></strong>
                </div>
                <div class="form-group col-md-12 col-lg-12">
