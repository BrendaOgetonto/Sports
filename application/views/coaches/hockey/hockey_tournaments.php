...
<html>
<head>
   <title>SU Sports | Scorpions Tornaments</title>
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
        <div class="row " style="margin-bottom: -15px;">
            <div class="col-lg-12 " >
                <h4 class="pull-left"><b>Dashboard</b> <span class="fa fa-angle-double-right"></span> Scorpions Tournaments</h4>
                <div class="pull-right">
                     <span data-placement="top" data-toggle="tooltip" title="Add Tournament">
                        <button class="btn btn-primary btn-xs" data-title="Add Tournament" data-toggle="modal" data-target="#tournament-modal" ><span class="fa fa-plus-circle"></span>&nbsp;Tournament</button>
                    </span>
                    ...
                    <thead>
                        <tr>
                           <th class="text-left">Tournament Dates</th>
                            <th class="text-left">Match Title</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                               ...
                               <!--  <form style="display:inline;" name=<?php echo '"formMore_'. $hms['hkm_auto_id'].'"';  ?> method="post" action="<?php echo base_url('coach/hockeymatchdetails');?>">
                                ...
                                <form style="display:inline;" name=<?php echo '"formMatch_'. $hms['game_auto_id'].'"';  ?> method="post" action="<?php echo base_url('coach/scorptournmatches');?>">
                                    <div class="form-group col-md-12 col-lg-12" style="display:none">
                                        <label for="tournamentId" class="control-label">Tournament ID*</label>
                                        <input required="required" class="form-control" name="tournamentId" id="tournamentId" value="<?php echo $hms['game_auto_id']; ?>">
                                    </div>
                                    <div class="form-group col-md-12 col-lg-12" style="display:none">
                                        <label for="tournamentTitle" class="control-label">Tournament Title*</label>
                                        <input required="required" class="form-control" name="tournamentTitle" id="tournamentTitle" value="<?php echo $hms['game_title']; ?>">
                                    </div>
                                    <button class="btn btn-default btn-xs" data-title="Add Match" id=<?php echo '"newmatch_'. $hms['game_auto_id'].'"';  ?> name=<?php echo '"newmatch_'. $hms['game_auto_id'].'"';  ?>  type="submit" style="background-color: #4D5656;color: #FFFFFF;"> <span class="fa fa-bars"></span> Matches </button>
                                </form>
<!-- 
 ...
 -->
                ...
                <!-- /.table-responsive -->
                <!-- matches-modal -->
                <div id="tournament-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="full-width-modalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog modal-full">
                        <div class="modal-content">
                            <div class="modal-header" style="border-bottom: none!important;margin-bottom: -20px">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h4 class="modal-title" id="full-width-modalLabel" ><strong style="color: darkred">New Tournament</strong></h4>
                            </div>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="col-md-12" >
                                                <div class="form-group col-md-6 col-lg-6">
                                                    <label for="matchTitle" class="control-label">Tournament Title <span class="star">*</span></label>
                                                ...
                                                <div class="form-group col-md-6 col-lg-6 " readonly="true">
                                                    <label for="startDate" class="control-label">Start Date <span class="star">*</span></label>
                                                    <div class='input-group date'>
                                                        <input type='text' class="form-control" data-mask="9999-99-99" name="startDate" placeholder="2017-11-20" id="startDate" required="required" />
