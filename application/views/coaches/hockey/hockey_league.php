...
<html>
<head>
   <title>SU Sports | Hockey League</title>
<?php $this->load->view('headerlinks/headerlinks.php'); ?> 
<link href="<?php echo base_url(); ?>assets/css/core.css" rel="stylesheet" type="text/css" />
  <style>
    @media (max-width:767px){ ul.typeahead.dropdown-menu
        { background-color: #E8F8F5;margin-right: 0px!important; margin-left: 5%!important;margin-right: 5%!important; margin-top: 50%!important;}
    #selectscorers{margin-left: 10px!important;min-width: 98%!important;}
     #selectscrs{margin-left: -3%!important;}}
    @media (min-width:768px){ ul.typeahead.dropdown-menu{background-color: #E8F8F5;margin-right: 0px!important;margin-left: 20%!important; margin-right: 3%!important; margin-top: 15%!important;}#selectscorers{ margin-left: 10px!important; min-width: 98%!important;}#selectscrs{margin-left: -2%!important;}}
  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
        <div class="row" style="margin-bottom: -15px;">
            <div class="col-lg-12 ">
                <h4><b>Dashboard</b> <span class="fa fa-angle-double-right"></span> Hockey League</h4>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box" >
            <div class="box-body">
                ...
                <!--  hockey-league-form -->
                 <form role="form" method="post" action="<?php echo base_url(); ?>coach/newhokleague" >
                        ...
                        <div class="col-xs-12">
                            <div class="col-md-12" >
                                ...
                                <div class="form-group col-md-12 col-lg-12">
                                    ...
                                    <textarea type="text" name="refComments" placeholder="" class=" form-control" id="refComments" required="required" maxlength="50"></textarea>
                                </div>
                                <div class="form-group col-md-12 col-lg-12">
                                    <label for="summary" class="control-label"> Game Summary</label>
                                    <textarea type="text" name="summary" placeholder="" class=" form-control" id="summary" required="required" maxlength="500"></textarea>
                                </div>
