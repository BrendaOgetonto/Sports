            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url('coach/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
                <a href="<?php echo base_url();?>coach/playeryfc"><span style="color: #1ABC9C;"><i class="fa fa-caret-right fa-fw"></i>&nbsp; Yellow Fever Card</span></a>
            </li>
          </ul>
        </li>
         <li class="treeview">
