...
<html>
<head>
   <title>SU Sports | Gladiators Leagues</title>
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
        <div class="row " style="margin-bottom: -15px;">
            <div class="col-lg-12 " >
                <h4 class="pull-left"><b>Dashboard</b> <span class="fa fa-angle-double-right"></span> Gladiators Leagues</h4>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                               ...
                               <!--  <form style="display:inline;" name=<?php echo '"formMore_'. $hms['hkm_auto_id'].'"';  ?> method="post" action="<?php echo base_url('coach/hockeymatchdetails');?>">
                                ...
                                <form style="display:inline;" name=<?php echo '"formMatch_'. $hms['game_auto_id'].'"';  ?> method="post" action="<?php echo base_url('coach/gladleaguematches');?>">
                                    <div class="form-group col-md-12 col-lg-12" style="display:none">
