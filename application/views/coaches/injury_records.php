                 ...
                 <table  class="table table-striped table-bordered table-hover display responsive nowrap" cellspacing="0" width="100%" id="injurylist"  >
                    ...
                    <?php foreach($injuries as $record)
                        ...
                        <tr>
                             ...
                             <td class="text-left"><img src="<?php echo base_url();?>assets/img/person.png" width="25" height="25" class="img-circle" alt="User Image"> <?php  echo $record['player_fname']. " ".$record['player_lname']; ?></td>
                            ...
                            <?php  echo '<form style="display:inline;" name='; echo '"formMore_'. $record['injury_auto_id'].'"';  echo 'method="post" action="'; echo base_url('coach/injurydetails');echo '">
