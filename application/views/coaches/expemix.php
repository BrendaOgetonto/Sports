  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
        <div class="row " style="margin-bottom: -15px;">
            <div class="col-lg-12 " >
                <h4 class="pull-left"><b>Dashboard</b> <span class="fa fa-angle-double-right"></span> Expenditures (Men)</h4>
          ...
          <div class="box" >
            <div class="box-body">
                    ...
                    <div style="display: none;background-color: #FFFFFF;color: #000000;border-bottom: 2px solid;border-color: #979A9A;" class="box-body">
                          <?php echo form_open('coach/newgeneralexpense',array('id' => 'newExpenditure','method'=>'post'));?>
                            <div class="col-md-12">
                                <div class="form-group col-md-6 col-lg-6 " hidden="true">
                                    ...
                                    <input type="text" name="category" class="form-control" id="category" required="required" value="General" >
                                </div>
                                <div class="form-group col-md-6 col-lg-6" >
                                    <label for="exDate" class="control-label"> Expenditure Date<span class="star">*</span></label>
                                    <input type="text" name="exDate" placeholder="YYYY-MM-DD" class="form-control" id="exDate" required="required" data-mask="9999-99-99">
                                </div>
                                <div class="form-group col-md-6 col-lg-6">
