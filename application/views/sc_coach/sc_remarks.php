...
<div id="wrapper">
    ...
    <div id="page-wrapper">
            ...
            <?php $msg = $this->session->flashdata('msg');
             $addRemark=$recordID;
            if ($addRemark==""){echo '<div></div>';}else if($addRemark!=""){ echo '
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <div class="messagebox alert text-left" style="display: block">
                                <div class="cs-text">
                                <form style="display:inline;" name='; echo '"formaddRemark_'. $addRemark.'"';  echo 'method="post" action="'; echo base_url("MC/crmks_view");echo '">
                                    <div class="form-group col-md-12 col-lg-12" style="display:none">
                                        <label for="recordId" class="control-label">Record ID*</label>
                                        <input required="required" class="form-control" name="recordId" id="recordId" placeholder="101" value="'; echo $addRemark; echo '">
                                    </div>
                                    <button class="btn btn-primary btn-s" data-title="Add Coach Remark" id='; echo '"addRemark_'. $addRemark.'"';  echo ' name='; echo '"addRemark_'. $addRemark.'"';  echo 'type="submit" ><span class="fa fa-plus-circle "> Add Coach Remark</span> 
                                   </button>
                    ...
                    <div class="col-xs-12">
                        ...
                        <?php foreach($injury_record as $record){ ?>
                            ...
                            <div class="form-group col-md-12 col-lg-12 ">
                                ...
                                <br><?php echo $record['injury_description']; ?></textarea>
                            </div>
                            <div class="form-group col-md-12 col-lg-12">
                            ...
                            <div class="form-group col-md-12 col-lg-12 ">
                                ...
                                <br><?php echo $record['diagnosis']; ?></textarea>
                            </div>
                            <div class="form-group col-md-12 col-lg-12">
                                <div class="modal-header"></div>
                            </div>
                             <div class="form-group col-md-12 col-lg-12 ">
                                ...
                                <br><?php echo $record['treatment'];?></textarea>
                            </div>
                            <div class="form-group col-md-12 col-lg-12">
                                <div class="modal-header"></div>
                            </div>
                             <div class="form-group col-md-12 col-lg-12 ">
                                ...
                                <br><?php echo $record['physio_remarks']; ?></textarea>
                            </div>
                            <div class="form-group col-md-12 col-lg-12">
                                <div class="modal-header"></div>
                            </div>
                             <div class="form-group col-md-12 col-lg-12 ">
                                <label for="physioRemarks" class="control-label">Coach Remarks</label>
                                <br><?php echo $record['coach_remarks'];} ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
