...
<html lang="en">
    <head>
        ...
        <title>Strathmore Sports Management System</title>
        <!-- bootstrap -->
    ...
    <body id="body" style="border:1px solid">
                    ...
                    <div class="omb_login" >
                        ...
                        <div class="row omb_row-sm-offset-3">
                            ...
                            <?php $msg = $this->session->flashdata('msg');
                                ...
                                <form class="omb_loginForm" accept-charset="UTF-8" role="form" autocomplete="off" method="POST" action="<?php echo base_url(); ?>login/lg">
      ...
      <!-- custom script with custom js definitions -->
    <script src="<?php echo base_url();?>assets/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap Core JavaScript -->
    <!-- Latest compiled and minified JavaScript -->
    <script src="<?php echo base_url();?>assets/bootstrap/3.1.0/js/bootstrap.min.js"></script>
